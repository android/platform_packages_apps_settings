...
import static com.android.settings.development.BluetoothSnoopLogPreferenceController.BLUETOOTH_BTSNOOP_LEGACY_ENABLE_PROPERTY;
...
public class BluetoothSnoopLogPreferenceControllerTest {
    ...
    @Test
    public void verifyLegacyPropertyTranslation_enabledToFull() {
        SystemProperties.set(BLUETOOTH_BTSNOOP_LOG_MODE_PROPERTY,
                mListValues[BluetoothSnoopLogPreferenceController.BTSNOOP_LOG_MODE_DISABLED_INDEX]
                        .toString());
        SystemProperties.set(BLUETOOTH_BTSNOOP_LEGACY_ENABLE_PROPERTY, Boolean.toString(true));
        BluetoothSnoopLogPreferenceController controller =
                new BluetoothSnoopLogPreferenceController(mSpyContext);
        assertThat(SystemProperties.get(BLUETOOTH_BTSNOOP_LEGACY_ENABLE_PROPERTY)).isEmpty();
        assertThat(SystemProperties.get(BLUETOOTH_BTSNOOP_LOG_MODE_PROPERTY)).isEqualTo(
                mListValues[BluetoothSnoopLogPreferenceController.BTSNOOP_LOG_MODE_FULL_INDEX]);
    }

    @Test
    public void verifyLegacyPropertyTranslation_disabledToExisting() {
        SystemProperties.set(BLUETOOTH_BTSNOOP_LOG_MODE_PROPERTY,
                mListValues[BluetoothSnoopLogPreferenceController.BTSNOOP_LOG_MODE_DISABLED_INDEX]
                        .toString());
        SystemProperties.set(BLUETOOTH_BTSNOOP_LEGACY_ENABLE_PROPERTY, Boolean.toString(false));
        BluetoothSnoopLogPreferenceController controller =
                new BluetoothSnoopLogPreferenceController(mSpyContext);
        assertThat(SystemProperties.get(BLUETOOTH_BTSNOOP_LEGACY_ENABLE_PROPERTY)).isEmpty();
        assertThat(SystemProperties.get(BLUETOOTH_BTSNOOP_LOG_MODE_PROPERTY)).isEqualTo(
    ...
    public void verifyResourceSizeAndRange() {
        ...
        int defaultIndex = BluetoothSnoopLogPreferenceController.DEFAULT_BTSNOOP_LOG_MODE_INDEX;
        ...
        assertThat(SystemProperties.get(
                BluetoothSnoopLogPreferenceController.BLUETOOTH_BTSNOOP_LEGACY_ENABLE_PROPERTY)).isEmpty();
    }
    ...
    public void onDeveloperOptionsDisabled_shouldDisablePreference() {
        ...
        assertThat(mPreference.getValue()).isEqualTo(
                mListValues[BluetoothSnoopLogPreferenceController.DEFAULT_BTSNOOP_LOG_MODE_INDEX]
                        .toString());
        assertThat(mPreference.getSummary()).isEqualTo(
                mListEntries[BluetoothSnoopLogPreferenceController.DEFAULT_BTSNOOP_LOG_MODE_INDEX]
                        .toString());
    }
}
