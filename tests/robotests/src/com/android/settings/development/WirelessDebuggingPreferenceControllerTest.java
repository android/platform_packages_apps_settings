...
public class WirelessDebuggingPreferenceControllerTest {
    ...
    @Test
    public void updateState_adbWifiEnabled_preferenceShouldBeChecked() throws RemoteException {
    ...
    @Test
    public void updateState_adbWifiDisabled_preferenceShouldNotBeChecked() throws RemoteException {
        Global.putInt(mContext.getContentResolver(),
