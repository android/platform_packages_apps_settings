...
public class PlatformCompatDashboardTest {
    ...
    @Test
    public void createPreferenceForChange_defaultEnabledChange_shouldCreateCheckedSwitchPreference() {
    ...
    public void createPreferenceForChange_defaultDisabledChange_shouldCreateUncheckedSwitchPreference() {
    ...
    @Test
    public void createChangeCategoryPreference_enabledAndDisabled_hasFooTitleAndSwitchPreferences() {
