...
public class LaunchSettingsTest {
  ...
  private static final String[] Pages = {"Settings", "Wi-Fi", "BlueTooth", "Application", "Battery"};
...
//  }
  ...
  private void launchPages(String activity, String text, int page) throws Exception {
    String mString = mDevice.executeShellCommand("am start -W -a" + activity);
  ...
  private int handleShellCommandResult(int page, String s) {
    if (s == "") {
      return 0;
    }
