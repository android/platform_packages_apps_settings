...
//  }
  ...
  private void printResult() {
    for (String string : map.keySet()) {
      ...
      RESULT.putString(String.format("LaunchSettingsTest_%s_%s", string, "max"), getMax(map.get(string)));
      RESULT.putString(String.format("LaunchSettingsTest_%s_%s", string, "min"), getMin(map.get(string)));
      RESULT.putString(String.format("LaunchSettingsTest_%s_%s", string, "avg"), getAvg(map.get(string)));
    }
  }
