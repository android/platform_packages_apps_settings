...
public class LaunchSettingsTest {
    ...
    public void setUp() throws Exception {
        ...
        mDefaultScreenTimeout = mDevice.executeShellCommand("settings get system screen_off_timeout");
    ...
    public void tearDown() throws Exception {
        ...
        if(mDefaultScreenTimeout.isEmpty()){
            mDevice.executeShellCommand("settings put system screen_off_timeout " + DEFAULT_SCREEN_TIMEOUT);
        }
        else{
            mDevice.executeShellCommand("settings put system screen_off_timeout " + mDefaultScreenTimeout);
        }
    }
