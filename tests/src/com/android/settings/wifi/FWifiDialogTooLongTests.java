...
public class FWifiDialogTooLongTests extends ActivityInstrumentationTestCase2<WifiSettings> {

    public FWifiDialogTooLongTests() {
        super("com.android.settings", WifiSettings.class);
    }
