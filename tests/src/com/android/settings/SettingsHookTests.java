...
public class SettingsHookTests extends ActivityInstrumentationTestCase2<Settings> {
    ...
    private static final String INTENT_OPERATOR_HOOK = "android.settings.OPERATOR_APPLICATION_SETTING";
    private static final String INTENT_MANUFACTURER_HOOK = "android.settings.MANUFACTURER_APPLICATION_SETTING";
