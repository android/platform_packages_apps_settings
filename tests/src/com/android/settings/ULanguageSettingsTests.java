...
public class ULanguageSettingsTests
        extends ActivityUnitTestCase<InputMethodAndLanguageSettingsActivity> {

    public ULanguageSettingsTests() {
        super(InputMethodAndLanguageSettingsActivity.class);
    }
    ...
    public void testSortInputMethods() {
        ...
        Method sortInputMethods = getMethod(InputMethodAndLanguageSettings.class, "prioritize");
