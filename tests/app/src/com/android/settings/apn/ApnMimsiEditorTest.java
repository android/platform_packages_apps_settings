package com.android.settings.apn;
 ...
 * adb shell am instrument -e class com.android.settings.apn.ApnMimsiEditorTest \
...
public class ApnMimsiEditorTest {
    ...
    public void setUp() throws Exception {
        ...
        apn = "test.test.com";
        mccMnc = "310260, 21010";
        Intent newApnIntent = new Intent(mTargetContext, Settings.ApnSettingsActivity.class);
    ...
    public void saveMccMnc_shouldNotCrash() throws Throwable {
        ...
        Intent newApnIntent = new Intent(mimsi_insert_action);
    ...
    public void editMccMnc_shouldNotCrash() throws Throwable {
        ...
        Intent newApnIntent = new Intent(mimsi_edit_action);
