...
class ConfigDialog extends AlertDialog implements TextWatcher,
    ...
    protected void onCreate(Bundle savedState) {
        ...
        if (mEditing) {
            ...
            changeType(convertTypeToVpnProfileConstant(mProfile.type));
            ...
            setUsernamePasswordVisibility(convertTypeToVpnProfileConstant(mProfile.type));
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if (parent == mType) {
            changeType(convertTypeToVpnProfileConstant(position));
     ...
     * legacy VPN hasn't removed from framework.
     */
    private int convertTypeToVpnProfileConstant(int type) {
        switch (type) {
            case 0:
    ...
    private boolean validate(boolean editing) {
        ...
        final int type = convertTypeToVpnProfileConstant(mType.getSelectedItemPosition());
    ...
    VpnProfile getProfile() {
        ...
        profile.type = convertTypeToVpnProfileConstant(mType.getSelectedItemPosition());
