...
class ConfigDialog extends AlertDialog implements TextWatcher,
    ...
    protected void onCreate(Bundle savedState) {
        ...
        Pair<Collection<String>, Collection<String>> keyAndCertAliases =
                AndroidKeystore.loadKeyAndCertificateAliases(null);
        loadCertificates(mIpsecUserCert, keyAndCertAliases.first, 0, mProfile.ipsecUserCert);
        loadCertificates(mIpsecCaCert, keyAndCertAliases.second,
                R.string.vpn_no_ca_cert, mProfile.ipsecCaCert);
        loadCertificates(mIpsecServerCert, keyAndCertAliases.second,
