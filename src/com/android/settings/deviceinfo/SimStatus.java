...
public class SimStatus extends PreferenceActivity {
    ...
    private static class MyHandler extends Handler {
        private WeakReference<SimStatus> mStatus;

        public MyHandler(SimStatus activity) {
            mStatus = new WeakReference<SimStatus>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            SimStatus status = mStatus.get();
            if (status == null) {
                return;
            }
            ...
            switch (msg.what) {
                ...
                case EVENT_SERVICE_STATE_CHANGED:
                    // TODO: mPhoneStateReceiver need sub id to divide
    ...
    protected void onResume() {
        ...
        if (mPhone != null) {
            ...
            mTelephonyManager.listen(mPhoneStateListener,
                    PhoneStateListener.LISTEN_DATA_CONNECTION_STATE, mUtility.getSimId());
    ...
    public void onPause() {
        ...
        if (mPhone != null) {
            ...
            mTelephonyManager.listen(mPhoneStateListener, 
                    PhoneStateListener.LISTEN_NONE, mUtility.getSimId());
        }
        if (mShowLatestAreaInfo) {
    ...
    private void updateNetworkType() {
        ...
        if (TelephonyManager.NETWORK_TYPE_UNKNOWN 
                != mTelephonyManager.getNetworkType(mUtility.getSimId())) {
    ...
    private void updateDataState() {
        int state = mTelephonyManager.getDataState(mUtility.getSimId());
    ...
    private void updateServiceState(ServiceState serviceState) {
        if (mUtility.getSimId() != serviceState.getSimId()) {
            return;
        }
    ...
    private void updatePreference() {
        ...
        if (mPhone.getPhoneName().equals("CDMA")) {
            ...
            if ("br".equals(mTelephonyManager.getSimCountryIso(mUtility.getSimId()))) {
