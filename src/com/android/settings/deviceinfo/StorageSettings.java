    ...
    private synchronized void refresh() {
        ...
        for (VolumeInfo vol : volumes) {
            if (vol.getType() == VolumeInfo.TYPE_PRIVATE) {
                ...
                StorageVolumePreference extStorageVolumePreference =
                ...
                extStorageVolumePreference.setEnabled(vol.getMountUserId() == UserHandle.myUserId());
                mExternalCategory.addPreference(extStorageVolumePreference);
            }
        }
