...
public class ApnEditor extends SettingsPreferenceFragment
    ...
    private static final String APN_DEFALUT_VALUES_STRING_ARRAY
            = "apn_default_values_strings_array";
    ...
    void fillUI(boolean firstTime) {
        if (firstTime) {
            ...
            String localizedName = Utils.getLocalizedName(getActivity(),
                    mApnData.getString(NAME_INDEX));
