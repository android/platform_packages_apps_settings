...
public class SmsDefaultSubscriptionController extends DefaultSubscriptionController {
    ...
    private final boolean mDoesSupportAskEveryTime;

    public SmsDefaultSubscriptionController(Context context, String preferenceKey) {
        super(context, preferenceKey);
        mDoesSupportAskEveryTime = mContext.getResources()
    ...
    @Override
    protected boolean doesSupportAskEveryTime() {
        return mDoesSupportAskEveryTime;
    }
