...
/**
 * An {@code ImsQuery} for accessing IMS capable stat
 */
public class ImsQueryCapableStat implements ImsQuery, Callable<Boolean> {
     ...
     */
    public ImsQueryCapableStat(int subId,
    ...
    public Boolean call() {
        ...
        return imsMmTelManager.isCapable(mCapability, mTech);
    }
}
