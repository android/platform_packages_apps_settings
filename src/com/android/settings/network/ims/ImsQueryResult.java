...
/**
 * A helper class to support query multiple items
 */
public class ImsQueryResult implements AutoCloseable {
    ...
    /**
     * Constructor
     * @param queries a list of {@code ImsQuery} to be performed
     */
    ...
    /**
     * Constructor
     * @param queryTimeoutInMs max. time allowed to perform query
     * @param queries a list of {@code ImsQuery} to be performed
     */
     ...
     * @param query {@code ImsQuery} which requested
     * @return query result in boolean format
     */
    ...
    /**
     * Class for generating a {@code Exception} for {@code ImsQuery} result
     */
    ...
    /**
     * Perform multiple ImsQuery, having all of the results in AND operation
     * @param queries a list of {@code ImsQuery} to be performed
     * @return combining all boolean result through AND operation
     */
