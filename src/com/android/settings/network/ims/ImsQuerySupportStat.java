...
/**
 * An {@code ImsQuery} for accessing IMS support stat
 */
public class ImsQuerySupportStat extends AbstractFuture<Boolean>
        implements ImsQuery, Consumer<Boolean> {
     ...
     */
    public ImsQuerySupportStat(int subId,
    ...
    public Future<Boolean> query(ExecutorService executors) throws Throwable {
        ...
        imsMmTelManager.isSupported(mCapability, mTransportType, executors, this);
        return this;
    }
