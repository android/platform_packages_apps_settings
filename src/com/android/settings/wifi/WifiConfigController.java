    ...
    private void showSecurityFields(boolean refreshEapMethods, boolean refreshCertificates) {
        ...
        if (refreshCertificates) {
            ...
            Pair<Collection<String>, Collection<String>> keyAndCertAliases =
                    AndroidKeystore.loadKeyAndCertificateAliases(KeyProperties.NAMESPACE_WIFI);
            loadCertificates(
                    mEapCaCertSpinner,
                    keyAndCertAliases.second,
                    null /* noCertificateString */,
                    false /* showMultipleCerts */,
                    true /* showUsePreinstalledCertOption */);
            loadCertificates(
                    mEapUserCertSpinner,
                    keyAndCertAliases.first,
                    mDoNotProvideEapUserCertString,
                    false /* showMultipleCerts */,
        ...
        if (initiateEnterpriseNetworkUi && mAccessPoint != null && mAccessPoint.isSaved()) {
            ...
            if (!TextUtils.isEmpty(enterpriseConfig.getCaPath())) {
                ...
                if (caCerts == null) {
                    ...
                    Pair<Collection<String>, Collection<String>> keyAndCertAliases =
                            AndroidKeystore.loadKeyAndCertificateAliases(
