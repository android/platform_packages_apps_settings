...
public final class WifiNoInternetDialog extends AlertActivity implements
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (ACTION_PROMPT_PRIVATE_DNS_BROKEN.equals(mAction)
            || ACTION_PROMPT_UNVALIDATED.equals(mAction)) {
            what = (ACTION_PROMPT_UNVALIDATED.equals(mAction)
                    ? "NO_INTERNET" : "PRIVATE_DNS_BROKEN");
