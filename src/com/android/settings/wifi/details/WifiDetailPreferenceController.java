...
public class WifiDetailPreferenceController extends AbstractPreferenceController
    ...
    private final NetworkCallback mNetworkCallback = new NetworkCallback() {
        ...
        private boolean hasPrivateDnsStatusChanged(NetworkCapabilities nc) {
            // If this is the first time that this module get NetworkCapabilities, report that
            // something is changed and assign nc to mNetworkCapabilities in onCapabilitiesChanged.
            // Note that the NetworkCapabilities from onCapabilitiesChanged() will never be null,
            // so here could compare mNetworkCapabilities and nc next time.
