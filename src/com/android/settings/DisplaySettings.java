...
import static android.provider.Settings.System.SCREEN_OFF_TIMEOUT_MODE;
import static android.provider.Settings.System.SCREEN_OFF_TIMEOUT_MODE_AUTOMATIC;
import static android.provider.Settings.System.SCREEN_OFF_TIMEOUT_MODE_MANUAL;
...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private void updateAutoSleepTimeoutPreferences(long currentTimeout) {
        ...
        final int timeoutMode = Settings.System.getInt(getContentResolver(),
                SCREEN_OFF_TIMEOUT_MODE, SCREEN_OFF_TIMEOUT_MODE_MANUAL);

        if (SCREEN_OFF_TIMEOUT_MODE_AUTOMATIC == timeoutMode) {
    ...
    private void updateTimeoutPreferenceDescription(long currentTimeout) {
        ...
        if (currentTimeout < 0) {
            ...
            Settings.System.putInt(getContentResolver(), SCREEN_OFF_TIMEOUT_MODE,
                    SCREEN_OFF_TIMEOUT_MODE_AUTOMATIC);
