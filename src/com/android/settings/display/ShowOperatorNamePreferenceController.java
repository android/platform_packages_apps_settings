...
public class ShowOperatorNamePreferenceController extends PreferenceController implements
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.System.putInt(mContext.getContentResolver(), KEY_SHOW_OPERATOR_NAME, value ? 1 : 0);
        return true;
    }

    @Override
    public void updateState(Preference preference) {
        int value = Settings.System.getInt(mContext.getContentResolver(), KEY_SHOW_OPERATOR_NAME, 1);
