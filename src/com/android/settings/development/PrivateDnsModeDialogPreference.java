...
public class PrivateDnsModeDialogPreference extends CustomDialogPreference
    ...
    private static final String SPECIFIER_KEY = Settings.Global.PRIVATE_DNS_SPECIFIER;
    ...
    private void saveHostnameToSettings(String hostname) {
        Settings.Global.putString(getContext().getContentResolver(), SPECIFIER_KEY, hostname);
    }
    ...
    private static String getHostnameFromSettings(ContentResolver cr) {
        return Settings.Global.getString(cr, SPECIFIER_KEY);
    }
