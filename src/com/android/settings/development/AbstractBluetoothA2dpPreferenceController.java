...
public abstract class AbstractBluetoothA2dpPreferenceController extends
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        synchronized (mBluetoothA2dpConfigStore) {
            if (mBluetoothA2dp != null) {
                ...
                setCodecConfigPreference(activeDevice, codecConfig);    // Use current active device
            }
        }
    ...
    public void updateState(Preference preference) {
        BluetoothDevice activeDevice = mBluetoothA2dp.getActiveDevice();
        if (getCodecConfig(activeDevice) == null
            || mPreference == null) { // Use current active device
            return;
        }
