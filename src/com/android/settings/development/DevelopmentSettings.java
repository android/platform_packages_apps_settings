...
public class DevelopmentSettings extends RestrictedSettingsFragment
    ...
    private static final String BLUETOOTH_ENABLE_AVDTP_DELAY_REPORTS =
    ...
    private void updateBluetoothEnableAvdtpDelayReportOptions() {
        updateSwitchPreference(mBluetoothEnableAvdtpDelayReport,
                SystemProperties.getBoolean(BLUETOOTH_ENABLE_AVDTP_DELAY_REPORTS, false));
    }

    private void writeBluetoothEnableAvdtpDelayReportOptions() {
        SystemProperties.set(BLUETOOTH_ENABLE_AVDTP_DELAY_REPORTS,
