...
public class PlatformCompatDashboard extends DashboardFragment {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(COMPAT_APP, getSelectedApp());
    }
    ...
    private void addPreferences() {
        ...
        getPreferenceScreen().addPreference(createAppPreference());
    ...
    private CompatibilityChangeConfig getAppChangeMappings() {
        try {
            ApplicationInfo applicationInfo = getPackageManager().getApplicationInfo(getSelectedApp(), 0);
    ...
    Preference createPreferenceForChange(Context context, CompatibilityChangeInfo change,
        ...
        boolean currentValue = configMappings.isChangeEnabled(change.getId());
    ...
    Preference createAppPreference() {
        try {
            ...
            appPreference.setIcon(applicationInfo.loadIcon(getPackageManager()));
            appPreference.setSummary(getSelectedApp()
                    + " SDK "
                    + applicationInfo.targetSdkVersion);
            appPreference.setKey(getSelectedApp());
    ...
    private void createChangeCategoryPreference(List<CompatibilityChangeInfo> changes,
    ...
    private class CompatChangePreferenceChangeListener implements OnPreferenceChangeListener {
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            try {
                ...
                getPlatformCompat().setOverrides(overrides, getSelectedApp());
            } catch (RemoteException e) {
                e.printStackTrace();
                return false;
            }
