...
public class WirelessDebuggingFragment extends DashboardFragment
    ...
    private static AdbIpAddressPreferenceController mAdbIpAddressPreferenceController;
    // UI components
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (AdbManager.WIRELESS_DEBUG_PAIRED_DEVICES_ACTION.equals(action)) {
                ...
                if (res.equals(AdbManager.WIRELESS_STATUS_PAIRING_CODE)) {
                    ...
                    String ipAddr = mAdbIpAddressPreferenceController.getIpv4Address() + ":" + port;
                    if (mPairingCodeDialog != null) {
    ...
    public Dialog onCreateDialog(int dialogId) {
        Dialog d = AdbWirelessDialog.createModal(getActivity(),
                dialogId == AdbWirelessDialogUiBase.MODE_PAIRING ? mPairingCodeDialogListener : null, dialogId);
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(
        ...
        mAdbIpAddressPreferenceController =
                new AdbIpAddressPreferenceController(context, lifecycle);
        controllers.add(mAdbIpAddressPreferenceController);
    ...
    public void onEnabled(boolean enabled) {
      Log.i(TAG, "onEnabled=" + enabled);
        if (enabled) {
            ...
            mAdbIpAddressPreferenceController.updateState(mIpAddrPreference);
        } else {
            showOffMessage();
        }
    }
