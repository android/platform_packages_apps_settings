...
public class CameraLongPressSettings extends DashboardFragment {
    ...
    public int getMetricsCategory() {
        return MetricsProto.MetricsEvent.SETTINGS_GESTURE_LONG_PRESS_CAMERA;
    }
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.long_press_camera_settings;
    }
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(
                    ...
                    sir.xmlResId = R.xml.long_press_camera_settings;
