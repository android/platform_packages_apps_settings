...
public class TetherSettings extends RestrictedSettingsFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        mEthernetRegex = getContext().getResources().getString(com.android.internal.R.string.config_ethernet_iface_regex);
    ...
    public void onStart() {
        ...
        mTm.registerTetheringEventCallback((runnable) -> runnable.run(), mTetheringEventCallback);
    ...
    private final class TetheringEventCallback extends
